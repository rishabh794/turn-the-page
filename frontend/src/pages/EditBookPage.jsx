    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-red-50">
        <div className="text-center">
          ...
          <p className="mt-6 text-gray-700 text-xl font-semibold">Loading book details...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-red-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-white to-orange-50 rounded-2xl shadow-lg p-8 mb-8 border-2 border-orange-200">
          ...
          <p className="text-gray-600 font-medium ml-16">Update the book information below</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 border-2 border-orange-200">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select 
                  ...
                  onChange={handleChange} 
                  required
                  className="w-full px-4 py-3 border-2 border-orange-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200 outline-none bg-gradient-to-r from-amber-50 to-orange-50 hover:bg-white cursor-pointer font-semibold text-gray-900"
                >
            ...
            {/* Error Message */}
            {error && (
              <div className="bg-gradient-to-r from-red-50 to-pink-50 border-2 border-red-300 p-4 rounded-2xl shadow-sm">
