    ...
    <div className={`min-h-screen ${
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16 lg:py-24">
          <div className="lg:w-1/2">
            ...
            <p className={`text-lg mb-8 max-w-lg font-medium ${
              isDark ? 'text-gray-300' : 'text-gray-700'
            }`}>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button className={`px-8 py-3 rounded-full font-bold shadow-md hover:shadow-lg transition-all duration-300 border-2 hover:scale-105 ${
                isDark
      ...
      {user && (
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className={`rounded-2xl shadow-md p-6 border-l-4 border-orange-500 ${
            isDark
      ...
      {!user && (
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className={`rounded-2xl shadow-md p-6 border-2 ${
            isDark
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          <div className={`rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 text-center border-2 hover:scale-105 ${
            isDark
        ...
        <div className="mb-8">
          ...
          <p className={`text-lg text-center mb-12 font-medium ${
            isDark ? 'text-gray-300' : 'text-gray-700'
          }`}>
      ...
      <div className="max-w-7xl mx-auto px-6 pb-16">
        <div className={`rounded-3xl shadow-lg p-8 mb-8 border-2 ${
          isDark
